...
<head>
    <meta charset="UTF-8">
    <title>Mi Perfil | Operador Blockbuster</title>
    ...
    <div class="container" style="max-width: 600px;">
        <div class="card shadow-lg" style="background-color: #1a1e27; border: 1px solid #333; border-radius: 10px;">
            ...
            <div class="card-body p-4 dark-form">
                ...
                <form action="<?= base_url('operador/perfil/actualizar') ?>" method="POST" enctype="multipart/form-data">
                    
                    <div class="form-group">
                        <label>Nombre Completo</label>
                        <?php $nombreActual = trim($operador->nombre_usuario . ' ' . $operador->ap_usuario . ' ' . $operador->am_usuario); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control dark-input" required 
                               value="<?= esc($operador->email_usuario) ?>">
                    </div>
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <a href="<?= base_url('operador/dashboard') ?>" class="btn btn-secondary ml-2" style="background-color: #333; border: none; padding: 10px 30px; color: white;">Regresar</a>
                    </div>
                </form>
