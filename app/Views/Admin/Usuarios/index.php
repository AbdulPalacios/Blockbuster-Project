...
<head>
 ...
 <style>
    ...
    .usuarios-btn-new:hover,
    .usuarios-btn-new:focus {
        color: #fff;
        text-decoration: none;
    ...
    .role-admin {
        ...
        color: #ff6666;
        border: 1px solid rgba(229, 54, 55, 0.28);
    }
...
<body>
    ...
    <div class="usuarios-alert">
        <?= session()->getFlashdata('success') ?>
    </div>
<?php endif; ?>

<div class="row mb-4 align-items-center usuarios-toolbar">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 text-lg-right text-md-right text-left">
        <a href="<?= base_url('admin/usuarios/crear') ?>" class="usuarios-btn-new">
        ...
        <table class="table usuarios-table">
            ...
            <tbody>
                <?php if (!empty($usuarios)): ?>
                    ...
                    <tr>
                        <td>
                            <span class="usuario-id">#<?= esc($u->id_usuario) ?></span>
                        </td>

                        <td>
                            <div class="usuario-name"><?= esc($u->nombre_usuario . ' ' . $u->ap_usuario) ?></div>
                        </td>

                        <td>
                            <div class="usuario-email"><?= esc($u->email_usuario) ?></div>
                        </td>

                        <td>
                            <?php if($u->id_rol == 745): ?>
                                <span class="usuario-role role-admin">Administrador</span>
                            <?php elseif($u->id_rol == 125): ?>
                                <span class="usuario-role role-operador">Operador</span>
                            <?php elseif($u->id_rol == 58): ?>
                                <span class="usuario-role role-cliente">Cliente</span>
                            <?php else: ?>
                                <span class="usuario-role role-default">Desconocido</span>
                            <?php endif; ?>
                        </td>

                        <td>
                            <?php if($u->estatus_usuario == 1): ?>
                                <span class="usuario-status status-active">Activo</span>
                            <?php else: ?>
                                <span class="usuario-status status-inactive">Inactivo</span>
                            <?php endif; ?>
                        </td>

                        <td class="text-center">
                            <div class="usuarios-actions">
                                <a href="<?= base_url('admin/usuarios/editar/'.$u->id_usuario) ?>" class="usuarios-action-btn edit" title="Editar">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="<?= base_url('admin/usuarios/eliminar/'.$u->id_usuario) ?>" class="usuarios-action-btn delete" title="Eliminar" onclick="return confirm('¿Deseas eliminar este usuario?');">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="usuarios-empty">
                                ...
                                <h5 style="color:#fff; font-weight:800; margin-bottom:8px;">No hay usuarios registrados</h5>
                                <p style="margin:0;">Empieza agregando el primer usuario al sistema.</p>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
